<?php
require_once('thanhtoan/nusoap.php');
$secure_pass = '!@#natura'; // Mật khẩu giao tiếp API của Merchant với NgânLượng.vn
...
{                    
	...
	{	
		...
		if($payment_type == 2)
		{			echo "Trường hợp là thanh toán tạm giữ, Lập trình thông báo thành công và cập nhật hóa đơn";exit();
		...
		{					echo "Trường hợp thanh toán ngay, Lập trình thông báo thành công và cập nhật hóa đơn";exit();
			// Lập trình thông báo thành công và cập nhật hóa đơn			
		}
	}
}
