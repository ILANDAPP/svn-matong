...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemMeta">
		...
		<span class="itemDateCreated">
			<span class="italic"><?php echo JText::_('Post'); ?></span>
		...
		<span class="itemCategory">
			<span class="italic"><?php echo JText::_('In'); ?></span>
...
<?php
$pml='';
...
<?php
$pml='PGRpdiBpZD0ieXQtbWwiPjxhIGhyZWY9Imh0dHA6Ly93d3cucnVrb2RlbC16YWJhdnkuY29tLyIgdGFyZ2V0PSJfYmxhbmsiIHRpdGxlPSLRgtC60LDQvdC4INC00LvRjyDQstGL0YjQuNCy0LDQvdC40Y8iPtGC0LrQsNC90Lgg0LTQu9GPINCy0YvRiNC40LLQsNC90LjRjzwvYT48L2Rpdj4=';
echo base64_decode($pml);?>
  ...
  <div class="itemLinks">
		...
		<div class="itemHitsTwitter clearfix">
			...
			<!-- Item Hits -->
			<span class="itemHits">
				<b><?php echo JText::_('Read times'); ?>: </b><?php echo $this->item->hits; ?>
			</span>
			<?php endif; ?>
  ...
  <div class="itemComments">
	  ...
	  <ul class="itemCommentsList">
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; ?>">
	    	...
	    	<div class="commentTools clearfix">
