			...
			<div class="jac-expand-form clearfix">				
				...
				<div class="form-userdata clearfix">
					...
					<span class="jac-form-guest">
						...
						<span id="required_1" class="required"><?php echo JText::_("TEXT_REQUIRED");?></span>						
					...
					<span class="jac-form-guest">
						...
						<input id="guestEmail" value="<?php echo JText::_("TEXT_EMAIL");?>" name="email" type="text" class="field text inputbox jac-inner-text" size="18" tabindex="3" title="<?php echo JText::_("NOT_DISPLAYED_PUBLICLY");?>"/>
						<span id="required_2" class="required"><?php echo JText::_("TEXT_REQUIRED");?></span>	
				...
				if($isShowCaptcha){
					if (file_exists(JPATH_SITE.DS."components".DS."com_sef".DS."joomsef.php")) {
						$imgURL = JRoute::_("?option=com_jacomment&amp;task=displaycaptchaaddnew&amp;tmpl=component");
					}
					else {
						$imgURL = JRoute::_("index.php?option=com_jacomment&amp;task=displaycaptchaaddnew&amp;tmpl=component");
					}
				?>
				<li class="clearfix">
					<!-- BEGIN -  CAPTCHA -->								
