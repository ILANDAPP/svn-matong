...
<div class="ja-slidewrap<?php echo $skin_name;?> ja-<?php echo $source;?> <?php echo $classNav;?>" id="ja-slide-articles-<?php echo $module->id;?>" style="visibility:hidden">
  <div class="ja-slide-main-wrap<?php echo ($navAlignment == 'vertical_left' ? ' ja-slide-right' : '' )?>">
    ...
    <div class="ja-slide-main">
      <?php foreach( $list as $k=> $item ) :   
		...
		// $list[$k] = $item;
	 ?>
      <div class="ja-slide-item"> <?php echo $helper->renderImage ($item->title, $item->mainImage, $params, $mainWidth, $mainHeight );?> </div>
      <?php endforeach; ?>
    </div>
  ...
  <div class="ja-slide-descs">
    ...
    <div class="ja-slide-desc"> <a <?php echo $target; ?>  href="<?php echo   $item->link; ?>"> <span><?php echo  $helper->trimString( $item->title, $titleMaxChars );?></span> </a> <?php echo $helper->trimString( $item->introtext, $descMaxChars, $includeTags ); ?>
      <?php if ($showDescription=='desc' && $readmoretext!=''): ?>
      <a <?php echo $target; ?> class="readon readmore" href="<?php echo   $item->link; ?>"> <?php echo $readmoretext;?> </a>
      <?php endif; ?>
    </div>
    <?php endforeach; ?>
  </div>
    ...
    <div class="ja-slide-thumbs">
      ...
      <div class="ja-slide-thumb">
        <div  class="ja-slide-thumb-inner">
          ...
          <?php if( $navShowDate ) :  ?>
          <span class="ja-createdate clearfix"> <?php echo JTEXT::_("POSTED_DATE"). "&nbsp;	". JHTML::_('date', $item->date, JText::_('DATE_FORMAT_LC4')); ?> </span>
          <?php endif; ?>
          <?php if( $navShowdesc ):  ?>
  ...
  <div class="ja-slide-thumbs-wrap<?php echo $classNav;?>">
    <div class="ja-slide-thumbs">
      <?php foreach( $list as $key => $item ) : ?>
      <div class="ja-slide-thumb"> <span><?php echo ($key+1);?></span> </div>
      <?php endforeach; ?>
    </div>
    <div class="ja-slide-thumbs-mask" style=" display:none ">
      <div class="ja-slide-thumbs-mask-left">&nbsp;</div>
  ...
  <?php if ($control): ?>
  <div class="ja-slide-buttons clearfix"> <span class="ja-slide-prev">&laquo; <?php echo JText::_('PREVIOUS');?></span> <span class="ja-slide-playback">&lsaquo; <?php echo JText::_('PLAYBACK');?></span> <span class="ja-slide-stop"><?php echo JText::_('STOP');?></span> <span class="ja-slide-play"><?php echo JText::_('PLAY');?> &rsaquo;</span> <span class="ja-slide-next"><?php echo JText::_('NEXT');?> &raquo;</span> </div>
  <?php endif; ?>
  	 </div>
</div>
