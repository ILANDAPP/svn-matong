...
<div id="ns2-<?php echo $modId; ?>" class="nssp2 ns2-<?php echo $uniqid ?>">
	<div class="ns2-wrap">
										...
										<div style="padding:<?php echo $article_col_padding ?>">
											<div class="ns2-inner">
												...
												<?php /*Image position before title*/if ($article_show_image && $article_image_pos=='top' && $list[$i]->image): ?>
													...
													<?php endif; ?>	
														<img class="ns2-image" style="<?php echo $article_image_float ?>;<?php echo ($article_image_margin) ? "margin:$article_image_margin" : "" ?>" src="<?php echo modNSSP2CommonHelper::thumb($list[$i]->image, $article_thumb_width, $article_thumb_height, $article_thumb_ratio, $uniqid) ?>" width="<?php echo $article_thumb_width ?>" height="<?php echo $article_thumb_height ?>" alt="<?php echo $list[$i]->title ?>" title="<?php echo $list[$i]->title ?>" />
													<?php if ($article_linked_image): ?>		
														</a>
													<?php endif; ?>			
												<?php endif; ?>												
													...
													<div class="ns2-tools">
														<?php /*Show Author*/ if ($article_show_author): ?>
															<div class="ns2-author">
																<? echo '<span>' . JText::_('MODNS2_WRITTEN') . '</span>' . $list[$i]->author; ?>
															</div>
														<?php endif; ?>
												...
												<?php /*Virtuemart*/ if ($art_show_price || $art_show_cart_button) : ?>
													<div class="ns2-vm-bar">
														<?php /*Show Price*/ if ($art_show_price) : ?>
															<p class="ns2-vm-price"><span class='lbl_f'>Giá bán:</span><?php echo $list[$i]->price ?></p>
														<?php endif; ?>
		...
		?>
		<div class="ns2-links-wrap <?php if ($links_position=="right"): ?> col-2 flt-left<?php endif; ?>">
			<?php if ($links_more): ?>
									...
									<div class="ns2-inner">
										...
										<?php /*Show Image*/ if ($links_show_image && $links_image_pos=='top' && $list[$i]->image): ?>
											<?php if ($links_linked_image): ?>
												<a href="<?php echo $list[$i]->link ?>">
											<?php endif; ?>	
												<img class="ns2-image" style="<?php echo $links_image_float ?>;<?php echo ($links_image_margin) ? "margin:$links_image_margin" : "" ?>" src="<?php echo modNSSP2CommonHelper::thumb($list[$i]->image, $links_thumb_width, $links_thumb_height, $links_thumb_ratio, $uniqid) ?>" width="<?php echo $links_thumb_width ?>" height="<?php echo $links_thumb_height ?>" alt="<?php echo $list[$i]->title ?>" title="<?php echo $list[$i]->title ?>" />
											<?php if ($links_linked_image): ?>		
												</a>
											<?php endif; ?>	
										<?php endif; ?>													
...
<?php $doc->addStyleDeclaration ("#ns2-{$modId} .ns2-art-pages{height:{$article_slide_height}px}"); ?>
...
<?php $doc->addStyleDeclaration ("#ns2-{$modId} .ns2-links-pages{height:{$links_slide_height}px}"); ?>
window.addEvent('domready', function() {
	new nssp2({
