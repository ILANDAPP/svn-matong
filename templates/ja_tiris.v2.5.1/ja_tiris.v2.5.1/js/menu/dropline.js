...
function jasdl_setHover () {
    ...
    recoverx = document.getElementById("menu" + jasdl_recover.toString());
    if (recoverx) {
        $(recoverx).setStyle("background-position", "-100px 2px");
    }
}
...
function jasdl_clearHover () {
    ...
    recoverx = document.getElementById("menu" + jasdl_recover.toString());
    if (recoverx) {
        $(recoverx).setStyle("background-position", "50% 100%");
    }
}
